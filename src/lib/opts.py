...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='vis',
                             help=' vis | coco | kitti | coco_hp | pascal')
    ...
    self.parser.add_argument('--demo', default='/home/hy/CenterNet-master/images', 
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    self.parser.add_argument('--load_model', default='/home/hy/CenterNet-master/models/ctdet_coco_dla_1x.pth',
  ...
  def parse(self, args=''):
    ...
    opt.root_dir = '/home/hy/CenterNet-master'
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [512, 512], 'num_classes': 1, 
                'mean': [0.372, 0.378, 0.364], 'std': [0.191, 0.183, 0.194],
                'dataset': 'vis'},
